...
def get_last_release_version(group_id, artifact_id):
    ...
    url = "https://packages.aliyun.com/maven/repository/2028474-release-WUnnpM/" \
...
# xxx.py {checkType} {projectPath} {mavenUsername} {mavenPassword}
if __name__ == "__main__":
    ...
    # 测试云效制品库
    # test = get_last_release_version("com.meijian.base", "base-model")
    # print test
